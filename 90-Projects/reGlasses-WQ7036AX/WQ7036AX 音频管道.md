...
音频管道 (Audio Pipeline) 就是**声音从麦克风到手机的完整旅程**：4 颗 [[PDM 麦克风]] 采集声音 → 硬件滤波变 PCM → DSP 降噪增强 → Opus 压缩 → [[WQ Audio Protocol]] 打包 → [[BLE GATT]] 发给手机。这条管道是 reGlasses 最核心的功能之一。
...
- [[PDM 麦克风]] — 采集入口
- [[I2S 协议]] — 播放输出接口
- [[WQ Audio Protocol]] — 音频帧的传输封装
- [[BLE GATT]] — C3 Audio Stream
- [[MAX98357A 功放]] — 扬声器驱动
- [[数据流：声音从麦到手机]] — 完整数据流追踪笔记
- [[音频系统基础]] — 采样率/位深/AEC/Opus 等底层原理
- [[内存管理与 DMA]] — DMA 双缓冲、Cache 一致性
- [[中断 并发与同步机制]] — DMA 中断与音频任务之间的同步
