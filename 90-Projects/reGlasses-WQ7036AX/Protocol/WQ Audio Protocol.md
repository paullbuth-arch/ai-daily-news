...
**这是 SDK 已有的 4 类服务**。reGlasses 需要扩展 4 类新的（详见 [[reGlasses 扩展命令集]]）：
...
WQ Protocol 搞懂了 → 去看 [[reGlasses 扩展命令集]] 了解你要新增哪些命令。
或者 → 去看 [[reGlasses 跨芯片指令转发]] 了解命令如何从 BLE 转到 STTP 到 V881。

## 关联概念

- [[WQ Protocol 帧结构]] — bit-level 详细解析
- [[WQ Protocol 服务类型]] — 所有 Service/Command 列表
- [[reGlasses 扩展命令集]] — 新增的 4 类 Service 定义
- [[BLE GATT]] — WQ Protocol 帧通过 GATT 传输
- [[STTP 协议]] — WQ Protocol 帧也可通过 STTP 传输
- [[Snippet - WQ Protocol 帧打包解包]] — 代码模板
