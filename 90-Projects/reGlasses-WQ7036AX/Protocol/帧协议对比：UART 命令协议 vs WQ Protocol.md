...
reGlasses 有两套帧协议：[[UART 命令协议]] (app_uart_cmd) 跑在 UART 上 (WQ7036AX↔V881)，[[WQ Audio Protocol]] 跑在 BLE GATT 上 (WQ7036AX↔手机)。它们都在做"数据打包"这件事，但设计思路完全不同。

## 对比表

| 维度 | [[UART 命令协议]] (当前) | [[WQ Audio Protocol]] |
|------|--------|--------|
...
在 [[reGlasses 跨芯片指令转发]] 中，两条协议串联工作：
...
- [[UART 命令协议]] — UART 上的帧协议 (当前使用)
- [[WQ Audio Protocol]] — BLE 上的帧协议
- [[STTP 协议]] — UART 上的旧帧协议 (已弃用)
- [[reGlasses 跨芯片指令转发]] — 两种协议如何串联
