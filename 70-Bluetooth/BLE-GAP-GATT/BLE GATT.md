...
GATT 基础搞懂了 → 去看 [[BLE GATT Service]] 了解 reGlasses 具体定义了哪些 Characteristic。
或者 → 去看 [[BLE GAP 广播]] 了解连接建立前的广播阶段。

## 关联概念

- [[BLE GAP 广播]] — 连接建立前：广播让手机发现你
- [[BLE GATT Service]] — reGlasses 自定义的 7 个 Characteristic
- [[BLE SMP 配对]] — 安全配对和加密
- [[WQ Audio Protocol]] — 通过 GATT 传输的帧协议
- [[Snippet - BLE GATT Service 注册模板]] — 写新 Service 的代码模板
- [[RTOS 原理与 FreeRTOS]] — GATT 回调函数运行在哪个任务上下文
- [[中断 并发与同步机制]] — BLE 回调与主任务之间的同步
