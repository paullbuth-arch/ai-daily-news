...
class C {
  ...
  static const _light = _AppPalette(
    bgDeep: Color(0xFF17161E),
    bgCard: Color(0xFF201C27),
    bgCardMuted: Color(0xFF2B2230),
    bgSurface: Color(0xFF3A2A36),
    bgElevated: Color(0xFF523542),
    nav: Color(0xF0100F16),
    navBorder: Color(0xFF3E344A),
    border: Color(0xFF5E526A),
    borderGlow: Color(0xFFE0D6FF),
    divider: Color(0xFF3D3242),
    t1: Color(0xFFF8F4FF),
    t2: Color(0xFFE2DAEF),
    t3: Color(0xFFB4A8C4),
    tMuted: Color(0xFF817589),
    cyan: Color(0xFFB99AFF),
    cyanDim: Color(0x38B99AFF),
    purple: Color(0xFFF0E8FF),
    purpleDim: Color(0x38F0E8FF),
    mint: Color(0xFF78E2C2),
    greenDim: Color(0x2678E2C2),
    neonOrange: Color(0xFFFF9B83),
    orangeDim: Color(0x38FF9B83),
    ...
    metricGradient: LinearGradient(
      colors: [Color(0xFF0B0A12), Color(0xFF49306B), Color(0xFFC96869)],
      begin: Alignment.topLeft,
      end: Alignment.bottomRight,
    ),
    heroGradient: LinearGradient(
      colors: [Color(0xFFECECF5), Color(0xFF9B9FB0), Color(0xFF181720)],
      begin: Alignment.topLeft,
      end: Alignment.bottomRight,
    ),
    cyanGradient: LinearGradient(
    ...
    glassGradient: LinearGradient(
      colors: [Color(0xFF322837), Color(0xFF1C1924), Color(0xFF512731)],
      begin: Alignment.topLeft,
      end: Alignment.bottomRight,
    ),
  );
