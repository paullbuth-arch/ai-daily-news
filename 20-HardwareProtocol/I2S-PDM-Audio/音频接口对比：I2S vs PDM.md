...
reGlasses 同时用了 [[I2S 协议|I2S]] 和 [[PDM 麦克风|PDM]] 两种数字音频接口。I2S 连功放和 V881，PDM 连麦克风。你得知道为什么麦克风用 PDM 而不用 I2S。
...
- [[I2S 协议]] — 芯片间 PCM 音频传输
- [[PDM 麦克风]] — 数字麦克风采集
- [[WQ7036AX 音频管道]] — 两种接口在音频链中的位置
- [[MAX98357A 功放]] — I2S 接收端
- [[SDM0103B 数字麦]] — PDM 输出端
