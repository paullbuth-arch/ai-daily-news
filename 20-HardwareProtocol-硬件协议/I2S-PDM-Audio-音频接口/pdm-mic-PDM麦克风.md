...
PDM (Pulse Density Modulation，脉冲密度调制) 就像**用鼓点记录音乐**：声音高的时候鼓点密集，声音低的时候鼓点稀疏。只需要 2 根线 (CLK + DATA) 就能把声音从麦克风送进芯片——比 [[i2s-protocol-I2S协议|I2S 还少一根线]]。

## 为什么学它

reGlasses 有 **4 颗 PDM 数字麦克风** ([[sdm0103b-SDM0103B数字麦) 组成阵列]]，负责：
- 语音交互 (语音助手、唤醒词)
- 环境声音采集 (工业数据集)
- 通话音频
...
这就是 [[wq7036ax-audio-pipeline-WQ7036AX音频管道]] 的采集侧全链路。
...
- [[sdm0103b-SDM0103B数字麦]] — reGlasses 使用的具体麦克风
