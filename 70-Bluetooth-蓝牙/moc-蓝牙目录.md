...
| 文件 | 一句话 | 什么时候学 |
|------|--------|-----------|
| [[ble-gap-BLE-GAP广播]] | 广播包/扫描/连接建立——设备怎么被发现 | **最先学** |
| [[ble-gatt-BLE-GATT]] | Service/Characteristic/Read/Write/Notify——数据怎么交换 | **第二个学** |
| [[ble-gatt-service-BLE-GATT-Service]] | reGlasses 自定义的 7 个 Characteristic | 理解项目蓝牙设计 |
| [[ble-smp-BLE-SMP配对]] | Just Works/绑定/加密——安全连接 | 需要实现配对时 |
| [[ble-vs-wifi-无线对比]] | 带宽/功耗/适用场景对比 | 建立全局认知 |
