...
GATT Service 是 [[ble-gatt-BLE-GATT 中的**服务容器**]]，包含一组功能相关的 Characteristic。每个 Service 有唯一的 UUID。reGlasses 需要定义自定义 Service 来承载控制、音频、IMU 等业务。
...
- 帧格式：[[wq-audio-protocol-WQ-Audio-Protocol TRANS_UP 帧]]
...
- [[reglasses-cross-chip-reGlasses跨芯片转发]] — C1 写入后如何转发给 V881
