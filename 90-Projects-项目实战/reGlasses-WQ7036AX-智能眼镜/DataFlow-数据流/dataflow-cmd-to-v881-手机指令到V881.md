...
Step 3: WQ7036AX 解包 → 判断路由 → 重新打包为 [[uart-basics-UART基础 帧]]
...
手机 APP 用 [[wq-audio-protocol-WQ-Audio-Protocol 格式打包一条"开始录制"指令：]]
...
**路由规则**（详见 [[reglasses-cross-chip-reGlasses跨芯片转发）：]]
...
WQ7036AX 把 WQ Protocol 的 payload **重新打包**为 [[uart-basics-UART基础 帧：]]
